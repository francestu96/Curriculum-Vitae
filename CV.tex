...
\item[\normalfont \textcolor{ColorOne}{Sep. 2023}] \textbf{Leonardo S.P.A.}, Genoa\\ \medskip

\textbf{Backend Software Developer}\\

Backend developer for a module of a \textbf{Cyber Range platform} used for cybersecurity training and simulation. \\
Responsible for the design and development of backend components in \textbf{Python}, contributing to the implementation of platform features and the integration of services supporting cyber-defence exercises and realistic attack simulations.
...
\begin{description}
\raggedright
\item[\normalfont \textcolor{ColorOne}{Sep. 2021 -- Sep. 2023}] \textbf{Leonardo S.P.A.}, Genoa\\ \medskip
...
Developer and maintainer of the real estate agency website 
\myhref{https://casasavino.it}{Casasavino} and the booking platform 
\myhref{https://danopark.it}{DanoPark}, responsible for platform development, maintenance, and continuous enhancements.
...
\vfill
{\color{white}
\textbf{Technical Keywords:} Python, NodeJS, Angular, C\#, NextJS, Full-Stack Developer, Development, Cybersecurity, Cyber Range, Secure Software Development, Security Architecture, Network Security, 
Encryption, Critical Infrastructure Protection, API Development, Distributed Systems
}
